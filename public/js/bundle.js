...
var showAlert = function showAlert(type, msg) {
  var time = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 8;
  hideAlert();
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "User created! You can sign in once you're added as an admin");
              window.setTimeout(function () {
                location.assign("/admin");
              }, 1500);
            }
...
exports.updateSettings = exports.updateInstructor = void 0;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Lesson updated successfully!");
              window.setTimeout(function () {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"submitLesson.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.submitWaSignup = exports.submitLesson = exports.getLessonData = void 0;
...
var submitLesson = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Lesson request submitted! You should receive a call or text from your assinged instructor within 72 hours ");
              window.setTimeout(function () {
                location.assign("/");
              }, 7000);
            }
  ...
  return function submitLesson(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var getLessonData = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            return _context2.abrupt("return", res.data.data.lesson);
  ...
  return function getLessonData(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
...
var submitWaSignup = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(data) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Request submitted! You should receive a call or text  within 48 hours");
              window.setTimeout(function () {
  ...
  return function submitWaSignup(_x3) {
    return _ref3.apply(this, arguments);
  };
}();

exports.submitWaSignup = submitWaSignup;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"dates.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.formatTimestamp = exports.formatDateToPopulate = exports.currentDateTime = void 0;
var daysOfWeekArr = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"];
var monthsArr = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
var endings = ["th", "st", "nd", "rd", "th", "th", "th", "th", "th", "th"];

var formatTimestamp = function formatTimestamp(timestamp, date) {
  // Get Day of Week
  var dayOfWeek = daysOfWeekArr[new Date(timestamp).getDay()]; // Get month

  var month = monthsArr[new Date(timestamp).getMonth()]; // Get day of month with proper ending (st, nd, rd, th,)

  var dayOfMonth = new Date(timestamp).getDate();
  var lastDigit = Number(String(dayOfMonth).slice(-1));
  var dateString = "".concat(dayOfMonth).concat(dayOfMonth == 11 ? "th" : endings[lastDigit]); // Get time and AM / PM

  var militaryTime = date.split("T")[1];
  var timeEnding = Number(militaryTime.split(":")[0]) > 12 ? "PM" : "AM";
  var timeArr = militaryTime.split(":");
  var formattedTimeInteger = Number(timeArr[0]) < 10 ? timeArr[0].slice(-1) : timeArr[0];
  var time = "".concat(timeArr[0] > 12 ? timeArr[0] - 12 : formattedTimeInteger, ":").concat(timeArr[1]).concat(timeEnding);
  var finalDateString = "".concat(dayOfWeek, ", ").concat(month, " ").concat(dateString, " @ ").concat(time);
...
var currentDateTime = function currentDateTime() {
  ...
  var localISOString = new Date(Date.now() - tzoffset).toISOString().slice(0, -1);
  var datetimeInputString = localISOString.substring(0, (localISOString.indexOf("T") | 0) + 6 | 0);
  return datetimeInputString;
};

exports.currentDateTime = currentDateTime;

var formatDateToPopulate = function formatDateToPopulate(e) {
  // Convert to YYYY-MM-DDTHH:MM
  var tempArr = e.date.split(": ")[0].split(" ");
  var tempYear = new Date().getFullYear();
  var tempMonth = String(monthsArr.indexOf(tempArr[1]) + 1).padStart(2, "0");
  var tempDay = tempArr[2].replace(/\D/g, "").padStart(2, "0");
  var tempTimeArr = tempArr[4].slice(0, -2).split(":");
  var isPM = tempArr[4].slice(-2).startsWith("P");
  var tempHour = isPM ? +tempTimeArr[0] + 12 : tempTimeArr[0].padStart(2, "0");
  var tempMin = tempTimeArr[1].padStart(2, "0");
  var finalStr = "".concat(tempYear, "-").concat(tempMonth, "-").concat(tempDay, "T").concat(tempHour, ":").concat(tempMin);
  return finalStr;
};

exports.formatDateToPopulate = formatDateToPopulate;
...
var _submitLesson = require("./submitLesson");
...
var userSignupForm = document.querySelector(".form-user-signup");
var userPasswordForm = document.querySelector(".form-user-password"); // Lesson Form

var lessonForm = document.querySelector(".form.lesson");
var lessonPopup = document.querySelector(".lessons__popup");
var lessonsList = document.querySelector(".lessons__list");
var lessons = document.querySelectorAll(".lesson"); // Water Aerobics

var heroBtn = document.querySelector(".hero--cta");
var waterAerobicsForm = document.querySelector(".form.wa--signup"); // Product Cards

var signupBtns = document.querySelectorAll(".product--card__btn"); // Hamburger Menu

var hamburger = document.querySelector(".hamburger");
var closeMobileNav = document.querySelector(".close--mobile__nav"); // Resize event handler for water aerobics page

window.addEventListener("resize", function () {
  if (!waterAerobicsForm) return;

  if (document.documentElement.clientWidth <= 600) {
    document.querySelector(".description--heading").textContent = "Water Aerobics";
...
if (lessonForm) lessonForm.addEventListener("submit", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var name, phone, age, gender, preferredTimes, preferredInstructor, addedNotes, today, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            preferredTimes = document.getElementById("preferredDates").value;
            preferredInstructor = document.getElementById("preferredInstructor").value;
            addedNotes = document.getElementById("addedNotes").value;
            ...
            _context.next = 12;
            return (0, _submitLesson.submitLesson)(data);
...
if (waterAerobicsForm) {
  ...
  waterAerobicsForm.addEventListener("submit", /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
      var name, phone, email, addedNotes, today, data;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 9;
              return (0, _submitLesson.submitWaSignup)(data);
...
if (userSignupForm) {
  userSignupForm.addEventListener("submit", /*#__PURE__*/function () {
...
if (lessonPopup) {
  lessonPopup.addEventListener("click", function (e) {
    var popupContainer = document.querySelector(".lessons__popup--container");
...
if (lessonsList) {
  lessons.forEach(function (lesson) {
    var popupContainer = document.querySelector(".lessons__popup--container");
    lesson.addEventListener("click", /*#__PURE__*/function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(e) {
        var lessonId, clickedLesson, instructorEl;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                lessonId = e.target.closest("li").dataset.id;
                lessonPopup.style.display = "flex";
                setTimeout(function () {
                  popupContainer.style.transform = "scale(1)";
                }, 10); //Populate popup data with clicked lesson

                _context6.next = 5;
                return (0, _submitLesson.getLessonData)(lessonId);

              case 5:
                clickedLesson = _context6.sent;

                if (clickedLesson.assignedInstructor) {
                  instructorEl = document.querySelector(".instructor");
                  instructorEl.style.display = "inline-block";
                  instructorEl.textContent = "Instructor: ".concat(clickedLesson.assignedInstructor);
                  document.querySelector(".lesson__btn.add").textContent = "Change Instructor";
                }

                document.querySelector(".lesson-name").textContent = clickedLesson.name;
                document.querySelector(".lesson-age").textContent = clickedLesson.age !== "Adult" ? "".concat(clickedLesson.age, " y/o ").concat(clickedLesson.gender) : "Adult ".concat(clickedLesson.gender);
                document.querySelector(".lesson-phone").textContent = "Phone: ".concat(clickedLesson.phone);
                document.querySelector(".lesson--notes").textContent = "Notes: ".concat(clickedLesson.addedNotes);
                document.querySelector(".lesson--preferred-times").textContent = "Preferred times: ".concat(clickedLesson.preferredTimes);
                document.querySelector(".lesson--date-received").textContent = clickedLesson.dateReceived;
                document.querySelector(".lesson__btn.add").addEventListener("click", function (e) {
                  console.log("CLICKED");
                  var addBtn = document.querySelector(".lesson__btn.add");
                  var saveBtn = document.querySelector(".lesson__btn.save");
                  var selectEl = document.querySelector(".form__select.admin");
                  selectEl.style.display = "block";
                  addBtn.style.display = "none";
                  saveBtn.style.display = "block";
                  saveBtn.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
                    var assignedInstructor;
                    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                      while (1) {
                        switch (_context5.prev = _context5.next) {
                          case 0:
                            assignedInstructor = selectEl.value;
                            selectEl.style.display = "none";
                            saveBtn.style.display = "none";
                            addBtn.style.display = "block"; // ToDo: Update DB and UI with added instructor

                            _context5.next = 6;
                            return (0, _updateSettings.updateInstructor)({
...
},{"./login":"login.js","./updateSettings":"updateSettings.js","./submitLesson":"submitLesson.js","./dates":"dates.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
